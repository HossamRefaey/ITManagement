...
namespace Othaim_Management.Views
{
    public partial class usr_Device_Model : UserControl
    {
        ...
        void cbxType()
        {
            cbx_Type.DataSource = t.List();
            cbx_Type.ValueMember = "type_id";
        ...
        {
            int check = int.Parse(cbx_Type.SelectedValue.ToString());
            

            model.Update(currentID, txt_ModelName.Text, txt_itemCode.Text, int.Parse(cbx_DevType.SelectedValue.ToString()), int.Parse(cbx_CategoryList.SelectedValue.ToString()), check);
            refresh();
        }

        private void btn_Save_Click(object sender, EventArgs e)
        {
            if(!string.IsNullOrWhiteSpace(txt_ModelName.Text)&&!string.IsNullOrWhiteSpace(txt_itemCode.Text)&&cbx_CategoryList.SelectedItem!=null&&cbx_DevType.SelectedValue!=null && cbx_Type.SelectedValue != null)
            {
                ...
                if (result.Count < 1)
                {
                    ...
                    model.Create(txt_ModelName.Text, txt_itemCode.Text, int.Parse(cbx_DevType.SelectedValue.ToString()), int.Parse(cbx_CategoryList.SelectedValue.ToString()), check);
                    refresh();
                }
                else
                {
        ...
        private void btn_Edit_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in result)
            {
                ...
                cbx_Type.SelectedValue = item.type_id;
            }
        }
