...
namespace Othaim_Management.Views
{
    public partial class usr_Devices : UserControl
    {
        ...
        void cbxStatusFill()
        {
            ...
            cbx_Status.ValueMember = "status_id";
        ...
        private void btn_Edit_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in result)
            {
                try
                {
                    ...
                    cbx_Status.SelectedValue = item.status_id;
        ...
        private void btn_Save_Edit_Click(object sender, EventArgs e)
        {
            ...
            if (username == Properties.Settings.Default.userName)
            {
                ...
                cbx_DevType.SelectedItem != null && cbx_DevModel.SelectedValue != null && cbx_Status.SelectedItem != null && cbx_Type.SelectedItem != null)
                {
                    ...
                    txt_Notes.Text, int.Parse(cbx_BranchList.SelectedValue.ToString()), dept);
                    btn_Save_Edit.Visible = false;
                    refresh();
                }
                else
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(txt_Name.Text) && !string.IsNullOrWhiteSpace(txt_SN.Text) && cbx_CategoryList.SelectedItem!=null &&
                cbx_DevType.SelectedItem!=null && cbx_DevModel.SelectedValue!=null &&cbx_Status.SelectedItem!=null && cbx_Type.SelectedItem != null
                &&cbx_BranchList.SelectedItem != null)
            {
                var result = dev.ChekSerial(txt_SN.Text);
                if (result.Count() <= 0)
                {
                    string tosite = cbx_BranchList.SelectedValue.ToString() +" "+ cbx_DeptList.Text;
                    ...
                    devCycle.CreateDev(id, tosite, txt_SN.Text ,Convert.ToDateTime(DateTime.Now.ToString("dd/MM/yyyy")));
